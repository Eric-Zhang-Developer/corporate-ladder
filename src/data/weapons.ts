...
export const WEAPONS = {
  ...
  serbu: {
    ...
    apReload: 2,
    damage: 6,
    // Inside a shotgun's listed range the pattern always connects. Distance
    // is paid entirely through damage falloff, never a point-blank whiff.
    baseAccuracy: 1.0,
    bands: [
      { maxDist: 1, accMult: 1.0, dmgMult: 1.0 },
      { maxDist: 2, accMult: 1.0, dmgMult: 0.9 },
      // Devastating at arm's length, a paperweight past it (§4.2).
      { maxDist: 3, accMult: 1.0, dmgMult: 0.35 },
    ],
    magSize: 3,
    caliber: "shell",
    intendedBand: 0,
  ...
  m870: {
    ...
    bands: [
      { maxDist: 1, accMult: 1.0, dmgMult: 1.0 },
      { maxDist: 3, accMult: 1.0, dmgMult: 0.8 },
      { maxDist: 4, accMult: 1.0, dmgMult: 0.35 },
    ],
    magSize: 5,
    caliber: "shell",
  ...
  spas12: {
    ...
    bands: [
      { maxDist: 1, accMult: 1.0, dmgMult: 1.0 },
      { maxDist: 3, accMult: 1.0, dmgMult: 0.85 },
      { maxDist: 4, accMult: 1.0, dmgMult: 0.4 },
    ],
    magSize: 8,
    caliber: "shell",
